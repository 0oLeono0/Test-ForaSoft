...
- [x] 5. Сервер: интеграционные тесты на реальных сокетах
  ...
  - [x] 5.3 Чат, история, выход, удаление комнаты — **0.5 д**
  ...
  - [x] 5.4 Валидация, relay, rate limit, состояние медиа — **0.5 д**
